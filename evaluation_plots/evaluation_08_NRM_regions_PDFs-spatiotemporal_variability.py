...
plot_path = os.path.join(parameters['plot_path'], '08_NRM_region_PDFs_spatiotemporal_variability')
...
region_ids = parameters['region_codes_to_use_spatio_temporal']
...
for var in vars:
    ...
    for statistic in statistics:
        ...
        fn_plot = os.path.join(plot_path, 'NRM_region_PDF_spatio_temporal_variability_%s_annual_and_seasonal_%s_%s_%s.png' % (var, statistic, year_start, year_end))
        ...
        if not os.path.exists(fn_plot) or not skip_existing:
            ...
            for region_id in region_ids:
                ...
                temp_df = evl.read_in.prepare_spatiotemporal_data_for_all_gcms_and_statistics(
