...
plot_path = os.path.join(parameters['plot_path'], '06a_NRM_region_PDFs_spatial_variability')
...
for var in vars:
    ...
    for statistic in statistics:
        ...
        fn_plot = os.path.join(plot_path, 'NRM_region_PDF_spatial_variability_%s_annual_and_seasonal_%s_%s_%s.png' % (var, statistic, year_start, year_end))
